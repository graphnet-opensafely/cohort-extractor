...
from cohortextractor.graphnet_backend import (
    AppointmentStatus,
    escape_like_query_fragment,
    quote,
)
from tests.helpers import assert_results
from tests.graphnet_backend_setup import (
    APCS,
    CPNS,
    EC,
    ICNARC,
...
def set_database_url(monkeypatch):
    ...
    if "GRAPHNET_DATABASE_URL" in os.environ:
        monkeypatch.setenv("DATABASE_URL", os.environ["GRAPHNET_DATABASE_URL"])
